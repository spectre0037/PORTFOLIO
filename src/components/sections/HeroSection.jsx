...
export function HeroSection() {
  ...
  return (
    <section
      id="hero"
      className="section-shell relative overflow-hidden pt-32 md:pt-40"
    >
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-16 px-4 sm:px-6 lg:grid-cols-1 lg:px-8">
        <div>
          <motion.div
            ...
            className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs uppercase tracking-[0.3em] text-white/60"
          >
          ...
          <motion.div
            ...
            className="mt-5 text-lg font-medium text-[var(--accent-3)] md:text-2xl"
          >
          ...
          >
            Building intelligent digital experiences, scalable systems, and
            futuristic interfaces powered by AI and modern web technologies.
          </motion.p>
          ...
          >
            ...
            <Button variant="secondary" asChild>
              <a href="/public/assets/Resume.pdf" download="AbdullahBinZubair_Resume.pdf">
                <Download size={16} />
                Resume Download
              </a>
            </Button>
            ...
            {socialLinks.map((link) => {
              ...
              return (
                <a
                  key={link.label}
                  href={link.href}
                  className="glass magnetic-hover inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm text-white/75 transition hover:-translate-y-1 hover:text-white"
                >
                  <Icon size={15} />
                  {link.label}
                </a>
